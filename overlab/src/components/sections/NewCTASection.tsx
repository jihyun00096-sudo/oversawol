  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={{
          background: [
            'radial-gradient(ellipse at 50% 50%, rgba(163,230,53,0.1) 0%, transparent 65%)',
            'radial-gradient(ellipse at 50% 50%, rgba(163,230,53,0.16) 0%, transparent 65%)',
            'radial-gradient(ellipse at 50% 50%, rgba(163,230,53,0.1) 0%, transparent 65%)',
          ],
        }}
          ...
          <div className="overflow-hidden mb-8">
            ...
            >
              ...
              >
                미래는<br />
                {' '}
                <span style={{ color: 'var(--lime-primary)', textShadow: '0 0 50px rgba(163,230,53,0.28)' }}>
                  이미
                </span>
                <br />
                여기 있습니다.
